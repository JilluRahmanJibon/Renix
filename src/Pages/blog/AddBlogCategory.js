            ...
            <div className="container px-6 md:max-w-6xl w-full ">
                <div className="md:max-w-xl mx-auto">
                    ...
                    <form className='shadow-lg shadow-gray-300 p-8 rounded'>
                        <div className="mb-6">
                            <label for="repeat-password" className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Blog Category</label>
                        ...
                        <div className="text-center">
                            <button type="submit" className="text-white bg-primary hover:bg-lightPrimary focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center ">Add Blog</button>
                        </div>
