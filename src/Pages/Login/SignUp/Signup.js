...
const SignUp = () => {
	...
	return (
		<div className="bg-[#D5E8B9] flex justify-center items-center w-full sm:h-screen h-full">
			<section className="sm:w-[450px]">
						...
						<div className="p-6 space-y-4 md:space-y-6 ">
							...
							<div>
								<button
									...
									className="  w-full py-2 flex justify-center items-center gap-1 px-1 text-gray-500 border-gray-500 rounded-lg hover:border-blue-gray-300 hover:text-white   hover:bg-blue-gray-300 transition-all border">
