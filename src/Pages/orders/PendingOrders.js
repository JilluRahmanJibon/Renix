                            ...
                            <tr className="bg-white border-b border-[#D0D2DA]">
                                ...
                                <td className="px-6 py-4">
                                    <span className="flex items-center gap-3">
                                        <button title='Confirm Order' className="text-lg text-[#0077FF] bg-[#BBDDFF] w-7  h-7 rounded-lg flex items-center justify-center">
                                            <AiOutlineCheckCircle />
                                        </button>

                                        <button title='Reject Order' className="text-lg text-[#F87171] bg-[#FEE2E2] w-7  h-7 rounded-lg flex items-center justify-center">
